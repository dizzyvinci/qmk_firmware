 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | RAISE***to g2| Ctrl | SPC***  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `----------------------------------------------ooooo-------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    RAISE, KC_LCTL, KC_SPC, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    MI_G3, MI_G2, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
